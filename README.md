...
- **일요일/공휴일 표시**: 일요일과 공휴일을 붉은색으로 표시
- **공휴일 정보**: 마우스 오버 시 공휴일명 툴팁 표시 (한국, 미국, 일본 등 지원)
...
![달력 팝업](resources/appstore/screenshot-popup_2880x1800.png)

### 공휴일 툴팁
공휴일에 마우스를 올리면 공휴일명이 표시됩니다.

![공휴일 툴팁](resources/appstore/screenshot-tooltip_2880x1800.png)

### 설정 화면
다양한 옵션을 설정할 수 있습니다.

![설정 화면](resources/appstore/screenshot-preference_2880x1800.png)
